...
public final class CrossModuleCodeMotionTest extends CompilerTestCase {
  ...
  protected int getNumRepetitions() {
    return 1; // We should always reach a fixed point in a single repetition.
  }
    ...
    test(
        createModuleChain(
            ...
            LINE_JOINER.join(
                "function f() {",
                "  var a;",
                "  a = 'local a'", // should not block movement of global a
                "}"),
            // m2
            "alert(a);"),
        new String[] {
          ...
          "",
          // m1
          LINE_JOINER.join("function f() {", "  var a;", "  a = 'local a'", "}"),
          // m2
          LINE_JOINER.join("var a = 5;", "alert(a);")
        });
  }

  public void testFunctionMovement1() {
    // This tests lots of things:
    // 1) f1 is declared in m0, and used in m1. Move it to m1
    // 2) f2 is declared in m0, and used in m2 twice. Move it to m2
    // 3) f3 is declared in m0, and used in m1+m2. It stays put
    // 4) g declared in m0 and never used. It stays put
    // 5) h declared in m1 and never used. It stays put
    // 6) f4 declared in m0 and used in m1 as var. It moves to m1
    ...
    JSModule[] modules =
        createModuleStar(
            ...
            // m2
            LINE_JOINER.join("f2('hi');", "f2('hi');", "f3('bye');"));

    test(
        modules,
        new String[] {
          // m0
          LINE_JOINER.join("function f3(a) { alert(a); }", "function g() { alert('ciao'); }"),
          // m1
          LINE_JOINER.join(
              "function f1(a) { alert(a); }",
              "function f4() { alert(1); }",
          ...
          // m2
          LINE_JOINER.join("function f2(a) { alert(a); }", "f2('hi');", "f2('hi');", "f3('bye');"),
        });
  }
  ...
  public void testTwoModulesAtSameDepth() {
    // Try out moving to the common ancestor with deeper ancestry chain
    JSModule[] modules =
        createModules(
            // m0
    ...
    // m3  m4      m3  m4
    modules[3].addDependency(modules[1]);
    modules[3].addDependency(modules[2]);
    modules[4].addDependency(modules[1]);
    modules[4].addDependency(modules[2]);

    // As the later module, m2 should be chosen over m1.
    test(
        modules,
        new String[] {
          // m0
  ...
  public void testClassMovement2() {
    test(
        createModuleChain(
            // m1
            LINE_JOINER.join("function f(){}", "f.prototype.bar=3;", "f.prototype.baz=5;"),
            // m2
            "f.prototype.baq = 7;",
            // m3
            "f.prototype.baz = 9;",
  ...
  public void testClassMovement_skipMultipleModules() {
    test(
        createModuleChain(
            // m1
            LINE_JOINER.join(
  ...
  public void testClassMovement3() {
    test(
        createModuleChain(
            // m1
            LINE_JOINER.join("var f = function() {};", "f.prototype.bar=3;", "f.prototype.baz=5;"),
            // m2
            "f = 7;",
            // m3
            "f = 9;",
  ...
  public void testVarMovement3() {
    ...
    JSModule[] modules =
        createModuleStar(
            // m1
            LINE_JOINER.join("var a = 0;", "var b = 1;"),
            // m2
            "var x = a + b;");
    ...
    test(
        ...
        new String[] {
          ...
          "",
          // m2
          LINE_JOINER.join("var a = 0;", "var b = 1;", "var x = a + b;")
        });
  }
